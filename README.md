...
- **SQL Database** - In-memory relational storage with a SQL subset: CREATE TABLE, DROP TABLE, SELECT, INSERT, UPDATE, DELETE, WHERE clause, ORDER BY, LIMIT, aggregations (COUNT, SUM, etc.), and column aliases
