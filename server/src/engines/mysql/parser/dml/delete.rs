...
use crate::engines::mysql::ast::{DeleteStmt, SqlStmt};
...
pub fn parse_search(pair: pest::iterators::Pair<Rule>) -> SqlResult<SqlStmt> {
    ...
    Ok(SqlStmt::Search(crate::engines::mysql::ast::SearchStmt {
        table,
        query,
    }))
}
...
pub fn parse_prepare(pair: pest::iterators::Pair<Rule>) -> SqlResult<SqlStmt> {
    ...
    Ok(SqlStmt::Prepare(crate::engines::mysql::ast::PrepareStmt {
        name,
        sql,
    }))
}
...
pub fn parse_execute(pair: pest::iterators::Pair<Rule>) -> SqlResult<SqlStmt> {
    ...
    Ok(SqlStmt::Execute(crate::engines::mysql::ast::ExecuteStmt {
        name,
        params,
    }))
}
