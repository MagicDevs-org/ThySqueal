...
use crate::engines_mysql::eval::{
    EvalContext, evaluate_condition_joined, evaluate_expression_joined,
};
use crate::engines_mysql::executor::window::WindowFunctionEvaluator;
use crate::engines_mysql::executor::{Executor, QueryResult, SelectQueryPlan};
use crate::squeal;
...
impl Executor {
    ...
    fn exec_set_operations(
        ...
        session: crate::engines_mysql::executor::Session,
